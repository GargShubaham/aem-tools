package com.adobe.aemtools.core.constants;

public interface Constants {
    String REPORT_PATHS = "reportPaths";
    ...
    /* Component List Constants*/
    String COMPONENT_PATH = "path";
    ...
    /* Generic Constants*/
    String EDITOR_MODE_URL = "/editor.html";

    /* Delete Reports Constants*/
    String DELETE_REPORTS_PATH = "deletepaths";


    /* Delete Reports Constants*/
    String DELETE_REPORTS_PARAMETER = "deletereports";
